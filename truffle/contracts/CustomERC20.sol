...
contract CustomERC20 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable {
    /* ========== 全局参数 ========== */
    uint8 private tokenDecimals;
    ///////////////////////////////////////////////////////////////////////////////
    // 交易燃烧参数
    // isBurn决定交易是否燃烧；
    // burnPercent为燃烧百分比，以万分之一为单位
    ///////////////////////////////////////////////////////////////////////////////
    ...
    // 交易手续费参数
    // isFee决定交易是否收费；
    // feePercent为收费百分比，以万分之一为单位；
    // feeBeneficiary为接收交易手续费地址
    ///////////////////////////////////////////////////////////////////////////////
    ...
    function init(address _creator, uint256 _totalSupply, string calldata _name, string calldata _symbol, uint8 _decimals, uint256 _tradeBurnRatio, uint256 _tradeFeeRatio, address _teamAccount) initializer public {
    ...
    /* ========== 功能函数 ========== */
    ///////////////////////////////////////////////////////////////////////////////
    // 销毁功能在ERC20BurnableUpgradeable.sol里面定义
